...
public class AddEditStudentDialog extends CustomDialogSkin {
    ...
    public AddEditStudentDialog(Window parent, ConnectionHandler connectionHandler, Student student) {
        ...
        ComboBox<String> qualificationComboBox = new ComboBox<>(FXCollections.observableArrayList("Hotel Management", "Culinary Arts"));
        ...
        actionButton.setOnAction(e -> {
            //if (studentNumberTextField.getText().length() >= 5 && studentNumberTextField.getText().matches("")) {//TODO Conditions
